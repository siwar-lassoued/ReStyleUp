...
package restyle_up.dim_taille_0_1;
 ...
 * @status
 */
public class Dim_Taille implements TalendJob {
	...
	private final String jobName = "Dim_Taille";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Dim_Taille.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_RESTYLE_UP_Dim_Taille = new byte[0];
		static byte[] commonByteArray_RESTYLE_UP_Dim_Taille = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RESTYLE_UP_Dim_Taille.length) {
					if (length < 1024 && commonByteArray_RESTYLE_UP_Dim_Taille.length == 0) {
						commonByteArray_RESTYLE_UP_Dim_Taille = new byte[1024];
					} else {
						commonByteArray_RESTYLE_UP_Dim_Taille = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_RESTYLE_UP_Dim_Taille, 0, length);
				strReturn = new String(commonByteArray_RESTYLE_UP_Dim_Taille, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_RESTYLE_UP_Dim_Taille, 0, length);
				strReturn = new String(commonByteArray_RESTYLE_UP_Dim_Taille, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RESTYLE_UP_Dim_Taille) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("Dim_Taille");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Dim_Taille");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:JntsodrGhB1iZCfCzzbEtV/RFQ2owS4J8XvDg4Y3VHUXWfsj");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Dim_Taille")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"ID_Taille\" INT4 ,\"Taille\" VARCHAR(255)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"ID_Taille\",\"Taille\") VALUES (?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:6WSE+0TaxaaszFZYD38dcUAPfBgQchyqJ326mxxZ64ALamBm");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						row3 = null;
						if (row2.Taille == null) {
							finder_tUniqRow_1.Taille = null;
						} else {
							finder_tUniqRow_1.Taille = row2.Taille.toLowerCase();
						}
						...
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							...
							if (row2.Taille == null) {
								new_tUniqRow_1.Taille = null;
							} else {
								new_tUniqRow_1.Taille = row2.Taille.toLowerCase();
							}
...
// # Output table : 'out1'
								out1_tmp.ID_Taille = Numeric.sequence("s1", 1, 1);
								out1_tmp.Taille = row3.Taille;
								out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (out1.ID_Taille == null) {
									...
									pstmt_tDBOutput_1.setInt(1, out1.ID_Taille);
								}

								if (out1.Taille == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, out1.Taille);
								}
...
// ###############################      
	...
	public static void main(String[] args) {
		final Dim_Taille Dim_TailleClass = new Dim_Taille();

		int exitCode = Dim_TailleClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Taille.class.getClassLoader()
					.getResourceAsStream("restyle_up/dim_taille_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Taille.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Taille");
		}
...
/************************************************************************************************
 * 80868 characters generated by Talend Open Studio for Data Integration on the
 * 10 avril 2025 à 10:17:08 AM CET
 ************************************************************************************************/