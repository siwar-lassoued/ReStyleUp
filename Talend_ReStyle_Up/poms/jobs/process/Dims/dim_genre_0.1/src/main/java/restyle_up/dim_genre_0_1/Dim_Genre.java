...
package restyle_up.dim_genre_0_1;
...
public class Dim_Genre implements TalendJob {
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_RESTYLE_UP_Dim_Genre = new byte[0];
		static byte[] commonByteArray_RESTYLE_UP_Dim_Genre = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RESTYLE_UP_Dim_Genre.length) {
					if (length < 1024 && commonByteArray_RESTYLE_UP_Dim_Genre.length == 0) {
						commonByteArray_RESTYLE_UP_Dim_Genre = new byte[1024];
					} else {
						commonByteArray_RESTYLE_UP_Dim_Genre = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_RESTYLE_UP_Dim_Genre, 0, length);
				strReturn = new String(commonByteArray_RESTYLE_UP_Dim_Genre, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_RESTYLE_UP_Dim_Genre, 0, length);
				strReturn = new String(commonByteArray_RESTYLE_UP_Dim_Genre, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RESTYLE_UP_Dim_Genre) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("Dim_Genre");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Dim_Genre");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:AjdWeXM0HGooXWenKD98vHx/dIJwpYTOXzLPhFW2Oo/8X7tE");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Dim_Genre")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"ID_Genre\" INT4 ,\"Genre\" VARCHAR(255)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"ID_Genre\",\"Genre\") VALUES (?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:X4KLp1xOOAj/B04+JQ+NIosRoR1tYuFmcW7UqQRc4VM74ocP");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						String searchStr_tReplace_1_1 = "Femmeme" + "";
						row2.Genre = StringUtils.replaceAllStrictly(row2.Genre, searchStr_tReplace_1_1, "Femme" + "",
								true, false);
						...
						ope_tFilterRow_1.matches((row4.Genre != null), "Genre!=null failed");
...
// Start of branch "row5"
						if (row5 != null) {
							...
							row3 = null;
							if (row5.Genre == null) {
								finder_tUniqRow_1.Genre = null;
							} else {
								finder_tUniqRow_1.Genre = row5.Genre.toLowerCase();
							}
							...
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								...
								if (row5.Genre == null) {
									new_tUniqRow_1.Genre = null;
								} else {
									new_tUniqRow_1.Genre = row5.Genre.toLowerCase();
								}
...
// # Output table : 'out1'
									out1_tmp.ID_Genre = Numeric.sequence("s1", 1, 1);
									out1_tmp.Genre = row3.Genre;
									out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
								if (out1 != null) {
									...
									if (out1.ID_Genre == null) {
										...
										pstmt_tDBOutput_1.setInt(1, out1.ID_Genre);
									}

									if (out1.Genre == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, out1.Genre);
									}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Genre.class.getClassLoader()
					.getResourceAsStream("restyle_up/dim_genre_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Genre.class.getClassLoader()
...
/************************************************************************************************
 * 96550 characters generated by Talend Open Studio for Data Integration on the
 * 12 avril 2025 à 8:37:29 PM CET
 ************************************************************************************************/