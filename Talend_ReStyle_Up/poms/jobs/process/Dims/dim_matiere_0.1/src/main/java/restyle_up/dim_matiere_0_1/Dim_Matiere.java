...
package restyle_up.dim_matiere_0_1;
 ...
 * @status
 */
public class Dim_Matiere implements TalendJob {
	...
	private final String jobName = "Dim_Matiere";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Dim_Matiere.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_RESTYLE_UP_Dim_Matiere = new byte[0];
		static byte[] commonByteArray_RESTYLE_UP_Dim_Matiere = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RESTYLE_UP_Dim_Matiere.length) {
					if (length < 1024 && commonByteArray_RESTYLE_UP_Dim_Matiere.length == 0) {
						commonByteArray_RESTYLE_UP_Dim_Matiere = new byte[1024];
					} else {
						commonByteArray_RESTYLE_UP_Dim_Matiere = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_RESTYLE_UP_Dim_Matiere, 0, length);
				strReturn = new String(commonByteArray_RESTYLE_UP_Dim_Matiere, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_RESTYLE_UP_Dim_Matiere, 0, length);
				strReturn = new String(commonByteArray_RESTYLE_UP_Dim_Matiere, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RESTYLE_UP_Dim_Matiere) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("Dim_Matiere");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Dim_Matiere");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:oyh2hLf990WL3mXJC/yD5erUbdDAwUbGEm0BuiCTgE45WY0F");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Dim_Matiere"))
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"ID_Matiere\" INT4 ,\"Matiere\" VARCHAR(255)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"ID_Matiere\",\"Matiere\") VALUES (?,?)";
...
// ###############################
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "rrr");
				}
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:C9OArz443MVqnTKz/SBrj2r8Q46iCS/AbWf3B73BrCx/yKE1");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							rrr.Marque = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
						}
						if (colQtyInRs_tDBInput_1 < 2) {
							rrr.Type = null;
						} else {

							rrr.Type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							rrr.Couleur = null;
						} else {

							rrr.Couleur = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							rrr.Taille = null;
						} else {

							rrr.Taille = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							rrr.Matiere = null;
						} else {

							rrr.Matiere = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
						}
						if (colQtyInRs_tDBInput_1 < 6) {
							rrr.Prix_origine = null;
						} else {

							rrr.Prix_origine = rs_tDBInput_1.getFloat(6);
						...
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							rrr.Genre = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							rrr.Saison = null;
						} else {

							rrr.Saison = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							rrr.Collection = null;
						} else {

							rrr.Collection = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							rrr.Popularite = null;
						} else {

							rrr.Popularite = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
						}
...
// # Output table : 'out2'
							out2_tmp.Matiere = row1.Matiere.equals("Wool") ? "Laine"
									: row1.Matiere.equals("Denim") ? "Jean"
											: row1.Matiere.equals("Silk") ? "Soie" : row1.Matiere;
							out2 = out2_tmp;
// ###############################
...
// Start of branch "out2"
						if (out2 != null) {
							...
							row3 = null;
							if (out2.Matiere == null) {
								finder_tUniqRow_1.Matiere = null;
							} else {
								finder_tUniqRow_1.Matiere = out2.Matiere.toLowerCase();
							}
							...
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								...
								if (out2.Matiere == null) {
									...
									new_tUniqRow_1.Matiere = out2.Matiere.toLowerCase();
								}
...
// # Output table : 'out1'
									out1_tmp.ID_Matiere = Numeric.sequence("s1", 1, 1);
									out1_tmp.Matiere = row3.Matiere;
									out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
								if (out1 != null) {
									...
									if (out1.ID_Matiere == null) {
										...
										pstmt_tDBOutput_1.setInt(1, out1.ID_Matiere);
									}

									if (out1.Matiere == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, out1.Matiere);
									}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "rrr");
				}
...
// ###############################      
	...
	public static void main(String[] args) {
		final Dim_Matiere Dim_MatiereClass = new Dim_Matiere();

		int exitCode = Dim_MatiereClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Matiere.class.getClassLoader()
					.getResourceAsStream("restyle_up/dim_matiere_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Matiere.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Matiere");
		}
...
/************************************************************************************************
 * 89297 characters generated by Talend Open Studio for Data Integration on the
 * 12 avril 2025 à 8:43:39 PM CET
 ************************************************************************************************/