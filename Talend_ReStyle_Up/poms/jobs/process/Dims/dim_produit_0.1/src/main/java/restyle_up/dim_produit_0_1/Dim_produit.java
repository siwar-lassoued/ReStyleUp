...
package restyle_up.dim_produit_0_1;
 ...
 * @status
 */
public class Dim_produit implements TalendJob {
	...
	private final String jobName = "Dim_produit";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Dim_produit.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_RESTYLE_UP_Dim_produit = new byte[0];
		static byte[] commonByteArray_RESTYLE_UP_Dim_produit = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RESTYLE_UP_Dim_produit.length) {
					if (length < 1024 && commonByteArray_RESTYLE_UP_Dim_produit.length == 0) {
						commonByteArray_RESTYLE_UP_Dim_produit = new byte[1024];
					} else {
						commonByteArray_RESTYLE_UP_Dim_produit = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_RESTYLE_UP_Dim_produit, 0, length);
				strReturn = new String(commonByteArray_RESTYLE_UP_Dim_produit, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_RESTYLE_UP_Dim_produit, 0, length);
				strReturn = new String(commonByteArray_RESTYLE_UP_Dim_produit, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RESTYLE_UP_Dim_produit) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:9GYfSB0DiVNqzWutFOBUpctNMHtyeb6YOtozT5FGHsHuQtLv");
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"ID_produit\" INT4 ,\"Produit\" VARCHAR(255)  )");
				}
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:jl4aL3larFKGoTRE13U1IesUA/QeeNak0fho6HVN6gZ8tJz4");
...
// # Output table : 'out2'
							out2_tmp.Type = row2.Type.equals("Dress") ? "Robe"
									: row2.Type.equals("Jeans") ? "Jean"
											: row2.Type.equals("Shoes") ? "Chaussures"
													: row2.Type.equals("Sweater") ? "Pull"
															: row2.Type.equals("Jacket") ? "Veste" : row2.Type;
							out2 = out2_tmp;
// ###############################
...
// Start of branch "out2"
						if (out2 != null) {
							...
							row3 = null;
							if (out2.Type == null) {
								finder_tUniqRow_1.Type = null;
							} else {
								finder_tUniqRow_1.Type = out2.Type.toLowerCase();
							}
							...
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								...
								if (out2.Type == null) {
									new_tUniqRow_1.Type = null;
								} else {
									new_tUniqRow_1.Type = out2.Type.toLowerCase();
								}
...
// # Output table : 'out1'
									out1_tmp.ID_produit = Numeric.sequence("s1", 1, 1);
									out1_tmp.Produit = row3.Type;
									out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
								if (out1 != null) {
									...
									if (out1.Produit == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, out1.Produit);
									}
...
// ###############################      
	...
	public static void main(String[] args) {
		final Dim_produit Dim_produitClass = new Dim_produit();

		int exitCode = Dim_produitClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_produit.class.getClassLoader()
					.getResourceAsStream("restyle_up/dim_produit_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_produit.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_produit");
		}
...
/************************************************************************************************
 * 89259 characters generated by Talend Open Studio for Data Integration on the
 * 12 avril 2025 à 9:06:14 PM CET
 ************************************************************************************************/