...
package restyle_up.dim_saison_0_1;
 ...
 * @status
 */
public class Dim_Saison implements TalendJob {
	...
	private final String jobName = "Dim_Saison";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Dim_Saison.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_RESTYLE_UP_Dim_Saison = new byte[0];
		static byte[] commonByteArray_RESTYLE_UP_Dim_Saison = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RESTYLE_UP_Dim_Saison.length) {
					if (length < 1024 && commonByteArray_RESTYLE_UP_Dim_Saison.length == 0) {
						commonByteArray_RESTYLE_UP_Dim_Saison = new byte[1024];
					} else {
						commonByteArray_RESTYLE_UP_Dim_Saison = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_RESTYLE_UP_Dim_Saison, 0, length);
				strReturn = new String(commonByteArray_RESTYLE_UP_Dim_Saison, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_RESTYLE_UP_Dim_Saison, 0, length);
				strReturn = new String(commonByteArray_RESTYLE_UP_Dim_Saison, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RESTYLE_UP_Dim_Saison) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:zuWXtyAn9ceCikpWg5jnABFLlsR+fULLGLDW8bjfMKcxLoEL");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Dim_Saison")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
							+ "\"(\"ID_Saison\" INT4 ,\"Saison\" VARCHAR(255)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"ID_Saison\",\"Saison\") VALUES (?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:KyANaLQPN1fglgrISaJpzk8yGi0MCTATVoM3vfc85PT9E7AA");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						ope_tFilterRow_1.matches((row2.Saison != null), "Saison!=null failed");

						if (ope_tFilterRow_1.getMatchFlag()) {
							if (row4 == null) {
								row4 = new row4Struct();
							}
							row4.Saison = row2.Saison;
...
// Start of branch "row4"
						if (row4 != null) {
							...
							row3 = null;
							if (row4.Saison == null) {
								finder_tUniqRow_1.Saison = null;
							} else {
								finder_tUniqRow_1.Saison = row4.Saison.toLowerCase();
							}
							...
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								...
								if (row4.Saison == null) {
									new_tUniqRow_1.Saison = null;
								} else {
									new_tUniqRow_1.Saison = row4.Saison.toLowerCase();
								}
...
// # Output table : 'out1'
									out1_tmp.ID_Saison = Numeric.sequence("s1", 1, 1);
									out1_tmp.Saison = row3.Saison;
									out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
								if (out1 != null) {
									...
									if (out1.ID_Saison == null) {
										...
										pstmt_tDBOutput_1.setInt(1, out1.ID_Saison);
									}

									if (out1.Saison == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, out1.Saison);
									}
...
// ###############################      
	...
	public static void main(String[] args) {
		final Dim_Saison Dim_SaisonClass = new Dim_Saison();

		int exitCode = Dim_SaisonClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Saison.class.getClassLoader()
					.getResourceAsStream("restyle_up/dim_saison_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Saison.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Saison");
		}
...
/************************************************************************************************
 * 89658 characters generated by Talend Open Studio for Data Integration on the
 * 12 avril 2025 à 9:08:21 PM CET
 ************************************************************************************************/